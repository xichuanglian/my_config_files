...
beautiful.init("/home/dwei/.config/awesome/themes/crown/theme.lua")
...
vicious.register(thermalwidget, vicious.widgets.thermal, "| Temp: $1°C ", 15, {"coretemp.0", "core"} )

-- Create a battery widget
batwidget = wibox.widget.textbox()
vicious.register(batwidget, vicious.widgets.bat, "| Bat: $2% ($1 $3) ", 30, "BAT1")

-- Create a uptime widget
uptimewidget = wibox.widget.textbox()
vicious.register(uptimewidget, vicious.widgets.uptime, "| Uptime: $2:$3 ($4) ", 60)
...
for s = 1, screen.count() do
    ...
    bottom_layout_right:add(uptimewidget)
    bottom_layout_right:add(batwidget)
    bottom_layout_right:add(thermalwidget)
    bottom_layout_right:add(cpuwidget)
    bottom_layout_right:add(memwidget)

    local bottom_layout = wibox.layout.align.horizontal()
    bottom_layout:set_right(bottom_layout_right)
